...
public interface StubPaymentController {
    ...
    @GetMapping("/payment")
    Mono<ResponseEntity<String>> createPayment(@Valid @PathVariable String retrievalId,@Valid @PathVariable String fiscalCode,@Valid @PathVariable String noticeNumber);
