...
public interface StubPaymentController {
    ...
    @GetMapping("/payment")
    Mono<ResponseEntity<String>> createPayment(@Valid @RequestParam String retrievalId, @Valid @RequestParam String fiscalCode, @Valid @RequestParam String noticeNumber);
